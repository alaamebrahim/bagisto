...
return [
    ...
    'layouts' => [
        ...
        'shipments' => 'الشحنات',
        'invoices' => 'الفواتير',
        'catalog' => 'التحكم بالمنتجات',
        'products' => 'المنتجات',
        'categories' => 'الأقسام',
        'attributes' => 'المواصفات',
        'attribute-families' => 'تصنيف المواصفات',
        'customers' => 'العملاء',
        'groups' => 'المجموعات',
        'reviews' => 'التعليقات',
    ...
    'dashboard' => [
        ...
        'sales' => 'المبيعات',
        'top-performing-categories' => 'الأقسام الأعلى أداءاً',
        'product-count' => ':count المنتجات',
        'top-selling-products' => 'المنتجات الأكثر مبيعًا',
        'sale-count' => ':count المبيعات',
        'customer-with-most-sales' => 'أكثر العملاء مبيعات',
        'order-count' => ':count عدد أوامر الشراء',
        'revenue' => 'الإيرادات :مجموع',
        'stock-threshold' => 'بيانات المخزون',
        'qty-left' => ' المتاح :qty ',
    ],
    ...
    'datagrid' => [
        ...
        'position' => 'موضع',
        'locale' => 'لغة',
        'hostname' => 'عنوان الموقع',
        'email' => 'البريد الإلكتروني',
        'group' => 'المجموعة',
        'phone' => 'هاتف',
        'gender' => 'الجنس',
        'title' => 'العنوان',
        'layout' => 'التصميم الرئيسى',
        'url-key' => 'مفتاح URL',
        'comment' => 'تعليق',
    ...
    'users' => [
        'forget-password' => [
            ...
            'header-title' => 'استرجاع كلمة المرور',
            'email' => 'البريد الإلكتروني ',
            'password' => 'كلمه السر',
            'confirm-password' => 'تأكيد كلمة المرور',
        ...
        'roles' => [
            'title' => 'الصلاحيات',
            'add-role-title' => 'أضف الصلاحية',
            'edit-role-title' => 'حرر الصلاحية',
            'save-btn-title' => 'احفظ الصلاحية',
            'general' => 'إعدادات عامة',
            'name' => 'اسم',
            'description' => 'الوصف',
    ...
    'sales' => [
        'orders' => [
            ...
            'shipment-btn-title' => 'التوصيل',
            'invoice-btn-title' => 'الفاتورة',
            'info' => 'معلومات',
            'invoices' => 'الفواتير',
            'shipments' => 'الشحنات',
            ...
            'order-status-processing' => 'جارى التوصيل',
        ...
        'shipments' => [
            ...
            'order-date' => 'تاريخ الطلب',
            'customer-name' => 'اسم العميل',
            'total-qty' => 'إجمالى الكمية',
            'action' => 'الإجراء',
            'add-title' => 'أنشئ شحنة',
            'save-btn-title' => 'احفظ الشحنة',
            'qty-ordered' => 'أمر qty',
            'qty-to-ship' => 'كمية الشحن',
    ...
    'catalog' => [
        'products' => [
            ...
            'mass-delete-success' => 'تم الحذف',
            'mass-update-success' => 'تم التحديث',
            'configurable-error' => 'رجاء تحديد عنصر واحد على الأقل.',
            ...
            'no-result-found' => 'لا يوجد منتجات بنفس الاسم.',
            'channel' => 'القنوات',
        ...
        'families' => [
            'title' => 'تصنيفات المواصفات',
            'add-family-btn-title' => 'إضافة تصنيف',
            'add-title' => 'إضافة تصنيف',
            'edit-title' => 'حرر التصنيف',
            'save-btn-title' => 'حفظ التصنيف',
            'general' => 'إعدادات عامة',
            'code' => 'رمز التصنيف',
            'name' => 'الاسم',
            'groups' => 'المجموعات',
            ...
            'position' => 'موضع',
            'attribute-code' => 'الكود',
            'type' => 'النوع',
            'add-attribute-title' => 'إضافة خصائص',
            'search' => 'ابحث',
            'group-exist-error' => 'اسم المجموعة موجود مسبقاً.'
        ],
        'categories' => [
            'title' => 'الأقسام',
    ...
    'configuration' => [
        ...
        'tax-categories' => [
            ...
            'code' => 'الكود',
            'description' => 'الوصف',
            'select-taxrates' => 'اختر ضريبة المعدلات',
            'edit' => [
    ...
    'settings' => [
        ...
        'sliders' => [
            ...
            'name' => 'اسم',
            'add-title' => 'عنصر جديد',
            'edit-title' => 'حرر سلايدر',
            'save-btn-title' => 'احفظ سلايدر',
            'general' => 'إعدادات عامة',
            'image' => 'صورة',
            'content' => 'المحتوى',
            'channels' => 'القناة',
            'created-success' => 'عنصر السلايدر أنشئ بنجاح',
            'created-fault' => 'خطأ في إنشاء عنصر السلايدر',
            'update-success' => 'تم تحديث عنصر السلايدر بنجاح',
            'update-fail' => 'المنزلق لا يمكن تحديثه',
            'delete-success' => 'لا يستطيع حذف الأخير عنصر',
            'delete-fail' => 'تم حذف عنصر السلايدر بنجاح'
        ],
        ...
        'tax-rates' => [
            ...
            'edit' => [
                'title' => 'حرر معدل الضريبة',
                'edit-button-title' => 'تعديل'
            ],
            'zip_code' => 'الرمز البريدي',
            'is_zip' => 'تمكين Zip Range ',
            'create-success' => 'تم الانشاء بنجاح',
            'create-error' => 'حدث خطأ ما',
            'update-success' => 'تم التحديث بنجاح',
            'update-error' => 'خطأ! لا يمكن التحديث',
            'delete' => 'تم الحذف بنجاح',
            'atleast-one' => 'يجب تحديد عنصر واحد على الأقل'
        ],
        'development' => [
            'title' => 'تطوير',
        ]
    ...
    'promotions' => [
        'cart-rules' => [
            ...
            'children-categories' => '( الأقسام (للأطفال فقط',
            'parent-categories' => '(الأقسام (الوالدين فقط',
            'categories' => 'التصنيفات',
    ...
    'admin' => [
        ...
        'system' => [
            'catalog' => 'أقسام المنتجات',
            'products' => 'المنتجات',
            'guest-checkout' => 'الزوار واستكمال الطلبات',
            'allow-guest-checkout' => 'السماح لغير المستخدمين باستكمال الطلب',
            'allow-guest-checkout-hint' => 'تلميح: في حالة تشغيله ، يمكن تكوين هذا الخيار لكل منتج على وجه التحديد',
            'review' => 'المراجعات',
            'allow-guest-review' => 'السماح للزائر بكتابة مراجعات للمنتجات',
            'inventory' => 'المخزون',
            'stock-options' => 'خيارات الأسهم',
            'allow-backorders' => 'السماح بأوامر الاسترجاع',
            'customer' => 'العملاء',
            'settings' => 'الإعدادات',
            'address' => 'العنوان',
            'street-lines' => 'الشارع',
            ...
            'footer' => 'الفوتر',
            'content' => 'المحتوى',
            'footer-content' => 'نص الفوتر',
            'footer-toggle' => 'تبديل الفوتر',
