...
return [
    ...
    'customer' => [
        'compare' => [
            'text' => 'قارن',
            'compare_similar_items' => 'مقارنة المنتجات المماثلة',
            'added' => 'تم إضافة المنتج لقائمة المقارنة',
            'removed' => 'تم إضافة المنتج لقائمة المقارنة',
            'already_added' => 'المنتج موجود بقائمة المقارنة بالفعل',
            'empty-text' => "لا يوجد منتجات بقائمة المقارنة",
        ],
        'login-form' => [
            'sign-up' => 'حساب جديد',
            'new-customer' => 'عميل جديد',
            'registered-user' => 'مستخدم مسجل',
            'customer-login' => 'تسجيل الدخول',
